...
const Page = () => {
    ...
    
  {
    ...
    data.map( (item)=>
    <header >
    <div class="px-2 py-4 mt-16 flex flex-col justify-center items-center text-center">
...
<div class="container mx-auto">
  ...
  <div class="px-2 py-4 mt-16 flex flex-row justify-between items-center text-center">
